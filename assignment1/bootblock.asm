...
bootmain(void)
{
  ...
  if(elf->magic != ELF_MAGIC)
    ...
    7d62:	45 4c 46 
    7d65:	75 5e                	jne    7dc5 <bootmain+0x8f>
  ...
  eph = ph + elf->phnum;
    ...
    7d7d:	8d 04 03             	lea    (%ebx,%eax,1),%eax
    7d80:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(; ph < eph; ph++){
    7d83:	39 c3                	cmp    %eax,%ebx
    7d85:	73 38                	jae    7dbf <bootmain+0x89>
    pa = (uchar*)ph->paddr;
    7d87:	8b 73 0c             	mov    0xc(%ebx),%esi
    readseg(pa, ph->filesz, ph->off);
    7d8a:	8b 43 04             	mov    0x4(%ebx),%eax
    7d8d:	89 44 24 08          	mov    %eax,0x8(%esp)
    7d91:	8b 43 10             	mov    0x10(%ebx),%eax
    7d94:	89 44 24 04          	mov    %eax,0x4(%esp)
    7d98:	89 34 24             	mov    %esi,(%esp)
    7d9b:	e8 4e ff ff ff       	call   7cee <readseg>
    if(ph->memsz > ph->filesz)
    7da0:	8b 4b 14             	mov    0x14(%ebx),%ecx
    7da3:	8b 43 10             	mov    0x10(%ebx),%eax
    7da6:	39 c1                	cmp    %eax,%ecx
    7da8:	76 0d                	jbe    7db7 <bootmain+0x81>
      stosb(pa + ph->filesz, 0, ph->memsz - ph->filesz);
    7daa:	8d 3c 06             	lea    (%esi,%eax,1),%edi
...
stosb(void *addr, int data, int cnt)
{
  asm volatile("cld; rep stosb" :
    7daf:	b8 00 00 00 00       	mov    $0x0,%eax
    7db4:	fc                   	cld    
    7db5:	f3 aa                	rep stos %al,%es:(%edi)
    return;  // let bootasm.S handle error
  ...
  for(; ph < eph; ph++){
    ...
    7dba:	39 5d e4             	cmp    %ebx,-0x1c(%ebp)
    7dbd:	77 c8                	ja     7d87 <bootmain+0x51>
  }
